...
callback:function(a,e,l){e=document.getElementById(a.currentSceneId());a.triggerActionsByAttribute("data-timeline-complete-action",e,{event:l});var d=x(l.timelineName);a.triggerActionsByAttribute("data-timeline-complete-"+d+"-action",e,{event:l})}});var D={version:"1.0.8",getDefault:r,setDefault:function(a,e){"object"==typeof a?w=a:w[a]=e}};return D}());
