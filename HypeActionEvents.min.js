...
e,{event:l});var c=x(l.timelineName);a.triggerActionsByAttribute("data-timeline-complete-"+c+"-action",e,{event:l})}});var D={version:"1.1.3",getDefault:u,setDefault:function(a,e){"object"==typeof a?w=a:w[a]=e}};return D}());
